...
if __name__ == "__main__":
    ...
    for ct in cts:
        ...
        refcoco_result_file = f"/data/yashowardhan/FineShot/test/results/yoloworld_{file_ct}_refcoco_results.json"
        ...
        print("Dataset: VG")
        vg_result_file = f"/data/yashowardhan/FineShot/test/results/yoloworld_{file_ct}_vg_results.json"
