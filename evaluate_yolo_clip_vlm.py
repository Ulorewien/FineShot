...
if __name__ == "__main__":
    ...
    for ct in cts:
        ...
        for st in sts:
            ...
            refcoco_result_file = f"/data/yashowardhan/FineShot/test/results/yolo_clip_vlm_{file_ct}_{file_st}_refcoco_results.json"
            ...
            print("Dataset: VG")
            vg_result_file = f"/data/yashowardhan/FineShot/test/results/yolo_clip_vlm_{file_ct}_{file_st}_vg_results.json"
